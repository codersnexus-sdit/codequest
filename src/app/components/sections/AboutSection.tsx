...
export default function AboutSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-[#0a0a0f] text-white px-6 sm:px-12 md:px-20 lg:px-32 overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="pointer-events-none absolute -right-40 -top-32 w-[720px] h-[720px] opacity-60">
        <Image
          src="/assets/Bg%20Shape-Purple.png"
          alt=""
          fill
          priority
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        // 🔥 Removed max-w-4xl so it stretches full width
